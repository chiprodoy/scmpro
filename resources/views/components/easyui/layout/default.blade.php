...
`body` tag options:
  ...
  * sidebar-mini
-->
<body class="hold-transition sidebar-mini">    <noscript>You need to enable JavaScript to run this app.</noscript>
    <div class="wrapper">
...
<script src="{{ asset('assets/adminlte/js/demo.js')}}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('assets/adminlte/js/pages/dashboard3.js')}}"></script>
@yield('footerjs')
