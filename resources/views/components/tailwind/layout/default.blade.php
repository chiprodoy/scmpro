...
<html lang="{{ config('app.locale') }}">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/'.$theme.'/img/favicon.ico') }}" />
    @yield('css')
    ...
    <link
      rel="stylesheet"
      href="{{ asset('assets/tailwind/css/compiled-tailwind.min.css') }}"
    />
    <link
      rel="apple-touch-icon"
      sizes="76x76"
      href="{{ asset('assets/'.$theme.'/img/apple-icon.png') }}"
    />

    <link
      rel="stylesheet"
      href="{{ asset('assets/'.$theme.'/vendor/@fortawesome/fontawesome-free/css/all.min.css') }}"
    />


    <link rel="stylesheet" type="text/css" href="{{ asset('assets/'.$theme.'/vendor/easyui/themes/metro-blue/easyui.css') }}"/>

    <link rel="stylesheet" type="text/css" href="{{ asset('assets/'.$theme.'/vendor/easyui/themes/icon.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/'.$theme.'/vendor/easyui/themes/color.css') }}">
    <script type="text/javascript" src="{{ asset('assets/'.$theme.'/vendor/easyui/jquery.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/'.$theme.'/vendor/easyui/jquery.easyui.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/'.$theme.'/vendor/swal/sweetalert.min.js') }}"></script>
    ...
    <div id="root">
                ...
                ><div class="items-center flex">
                  <span
                    ...
                    ><img
                      ...
                      src="{{ asset('assets/'.$theme.'/img/team-1-800x800.jpg') }}"
                  /></span></div
              ></a>
              <div
                class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1"
      ...
      <div class="relative md:ml-64 bg-gray-100">
        ...
        <section class="content">
            <div class=" md:pt-32 pb-16 pt-12">
              <div class="px-6 md:px-3 h-full w-full">
                @yield('content')
              </div>
            </div>
        </section>
